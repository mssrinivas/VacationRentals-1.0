          ...
          <div class="item">
           <div class="image">
            ...
            <div class="content descrip">
              <a  href={redirect_url} value={this.props.value} onClick={id=>this.props.clicked(this.props.value)} class="header">{this.props.name}</a>
              <div class="meta">  
                <span class="cinema">{this.props.type}</span>
              </div>
              ...
              <div class="extra">
                ...
                <div class="ui label">{this.props.price} per night</div>
              </div>
            </div>
          </div>
          </div>
