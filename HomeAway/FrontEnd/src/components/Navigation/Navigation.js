    ...
    render(){
      console.log("PROPSS" + this.props.value)
        ...
        if(cookie.load('cookie')){
            ...
            tripsboard =(
              <li class="nav-item" >
                   <a class="nav-link lower" href="/tripsboard"><p class="backwhite">Trips Board</p><span class="sr-only">(current)</span></a>
            </li>)
            navLogin = (
               <li class="nav-item dropdown ">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                     ...
                     <a class="dropdown-item" href="/tripsboard">My Trips</a>
                     <a class="dropdown-item" href="/traveller/accounty">My Profile</a>
                     <a class="dropdown-item" href="#">Account</a>
                     <li><hr></hr></li>
                     <a class="dropdown-item" href="/owner/login" >Owner Dashboard</a>
                     <li><hr></hr></li>
